...
The Lua SDK for the Republicmag API — an entity-oriented client using Lua conventions.
...
GitHub release tag (`lua/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/republicmag-sdk/releases)),
...
| `tags` | `table` | Tags associated with the post |
...
```
lua/
├── republicmag_sdk.lua    -- Main SDK module
...
The main module (`republicmag_sdk`) exports the SDK constructor
