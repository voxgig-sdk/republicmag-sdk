...
describe("PostEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set REPUBLICMAG_TEST_POST_ENTID JSON to run live")
      return
    end
...
function post_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("REPUBLICMAG_TEST_POST_ENTID")
  ...
  if env["REPUBLICMAG_TEST_LIVE"] == "TRUE" then
  ...
  local live = env["REPUBLICMAG_TEST_LIVE"] == "TRUE"
  return {
    client = client,
    data = entity_data,
