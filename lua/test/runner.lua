...
function runner.env_override(m)
  local live = runner.getenv("REPUBLICMAG_TEST_LIVE")
  local override = runner.getenv("REPUBLICMAG_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("REPUBLICMAG_TEST_EXPLAIN")
