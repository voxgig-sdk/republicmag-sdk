...
func registerTools(server *mcp.Server, client *sdk.RepublicmagSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "republicmag_list",
		Description: "List records from Republicmag. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "republicmag_load",
		Description: "Load a single record from Republicmag. " +
...
func runOp(client *sdk.RepublicmagSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.RepublicmagSDK, name string) (sdk.RepublicmagEntity, error) {
