// Command Republicmag-mcp is an MCP server exposing the Republicmag
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Republicmag_list  — list records of an entity
//	Republicmag_load  — load a single record of an entity
//
