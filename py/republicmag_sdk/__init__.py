...
from republicmag_sdk.utility import register

# Load features
from republicmag_sdk.feature.base_feature import RepublicmagBaseFeature
from republicmag_sdk.features import _has_feature, _make_feature
...
class RepublicmagSDK:
    ...
    def get_utility(self):
        return RepublicmagUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("RepublicmagSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Post(self, data=None) -> "PostEntity":
        ...
        from republicmag_sdk.entity.post_entity import PostEntity
        return PostEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "RepublicmagSDK":
        if sdkopts is None:
            sdkopts = {}
