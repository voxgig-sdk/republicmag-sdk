...
from republicmag_sdk.core.control import RepublicmagControl
...
from republicmag_sdk.core.helpers import get_ctx_prop, to_map
...
class RepublicmagContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, RepublicmagSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, RepublicmagResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, RepublicmagResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return RepublicmagError(code, msg, self)
