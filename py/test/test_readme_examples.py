# Republicmag SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions RepublicmagSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both RepublicmagSDK(...) and RepublicmagSDK.test(...) become
#      RepublicmagSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "republicmag_sdk"
_SDK_CLASS = "RepublicmagSDK"
