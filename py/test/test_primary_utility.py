...
from republicmag_sdk.utility.voxgig_struct import voxgig_struct as vs
from republicmag_sdk import RepublicmagSDK
from republicmag_sdk.core.spec import RepublicmagSpec
from republicmag_sdk.core.result import RepublicmagResult
from republicmag_sdk.core.response import RepublicmagResponse
from republicmag_sdk.core.operation import RepublicmagOperation
from republicmag_sdk.core.error import RepublicmagError
from republicmag_sdk.core import helpers
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return RepublicmagError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = RepublicmagSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = RepublicmagSDK.test(None, None)
        ...
        class TestInitFeature(RepublicmagBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(RepublicmagBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = RepublicmagSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = RepublicmagSDK.test(None, setup_opts)
    ...
    def test_operator_basic(self):
        ...
        def subject(entry):
            ...
            if not isinstance(in_val, dict):
                in_val = {}
            op = RepublicmagOperation(in_val)
            return {
                "entity": op.entity,
                "name": op.name,
                "input": op.input,
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = RepublicmagSDK.test(None, setup_opts)
