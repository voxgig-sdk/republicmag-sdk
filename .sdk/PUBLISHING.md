...
|---|---|---|
| `ts/` | @voxgig-sdk/republicmag-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/republicmag-sdk \
      --repository voxgig-sdk/republicmag-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/republicmag-sdk` shows it, and
`npm trust revoke @voxgig-sdk/republicmag-sdk --id=<id>` removes it.
