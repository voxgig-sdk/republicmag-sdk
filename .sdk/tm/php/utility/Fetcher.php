...
// Republicmag SDK utility: fetcher

class RepublicmagFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; RepublicmagSDK/1.0)';
    ...
    public static function call(RepublicmagContext $ctx, string $fullurl, array $fetchdef): array
    {
