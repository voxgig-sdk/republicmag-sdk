...
class RepublicmagCacheFeature extends RepublicmagBaseFeature
{
    ...
    private function _through(RepublicmagContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
