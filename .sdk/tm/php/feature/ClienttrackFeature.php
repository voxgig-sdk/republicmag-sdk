...
// Republicmag SDK clienttrack feature
...
class RepublicmagClienttrackFeature extends RepublicmagBaseFeature
{
    ...
    public function PostConstruct(RepublicmagContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Republicmag-SDK';
