...
// Republicmag SDK ratelimit feature
...
class RepublicmagRatelimitFeature extends RepublicmagBaseFeature
{
    ...
    private function _acquire(RepublicmagContext $ctx): void
    {
    ...
    private function _track(RepublicmagContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
