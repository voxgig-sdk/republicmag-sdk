...
class RepublicmagProxyFeature extends RepublicmagBaseFeature
{
    ...
    public function init(RepublicmagContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (RepublicmagContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
