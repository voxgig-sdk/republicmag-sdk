...
// Republicmag SDK streaming feature
...
class RepublicmagStreamingFeature extends RepublicmagBaseFeature
{
    ...
    private function _iterate(RepublicmagResult $result): \Generator
    {
    ...
    private function _streamable(RepublicmagContext $ctx): bool
    {
