...
class RepublicmagRbacFeature extends RepublicmagBaseFeature
{
    ...
    private function _required(RepublicmagContext $ctx): ?string
    {
    ...
    private function _reject(RepublicmagContext $ctx, string $required): void
    {
    ...
    private function _track(RepublicmagContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
