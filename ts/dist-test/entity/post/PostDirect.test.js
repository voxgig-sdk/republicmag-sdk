...
(0, node_test_1.describe)('PostDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.RepublicmagSDK({
...
function liveScenariosActive() { return false && process.env.REPUBLICMAG_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.RepublicmagSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['REPUBLICMAG_TEST_POST_ENTID'];
    ...
    const client = new __1.RepublicmagSDK({
        base: 'http://localhost:8080',
