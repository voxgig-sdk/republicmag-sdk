...
function envOverride(m) {
    if ('TRUE' === process.env.REPUBLICMAG_TEST_LIVE ||
        'TRUE' === process.env.REPUBLICMAG_TEST_OVERRIDE) {
    ...
    m.REPUBLICMAG_TEST_EXPLAIN = process.env.REPUBLICMAG_TEST_EXPLAIN || m.REPUBLICMAG_TEST_EXPLAIN;
    return m;
}
