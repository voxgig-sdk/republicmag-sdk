# Republicmag Ruby SDK



The Ruby SDK for the Republicmag API — an entity-oriented client using idiomatic Ruby conventions.
...
- Releases: [https://github.com/voxgig-sdk/republicmag-sdk/releases](https://github.com/voxgig-sdk/republicmag-sdk/releases)
...
```ruby
require_relative "Republicmag_sdk"
client = RepublicmagSDK.new(options)
```
...
```ruby
client = RepublicmagSDK.test(testopts, sdkopts)
```
...
raise a `RepublicmagError` (a `StandardError` subclass), so wrap
...
```
rb/
├── Republicmag_sdk.rb       -- Main SDK module
...
The main module (`Republicmag_sdk`) exports the SDK class
