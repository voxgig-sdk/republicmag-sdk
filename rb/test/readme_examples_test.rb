...
#      offline in seeded test mode (RepublicmagSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "Republicmag_sdk.rb")
  SDK_CLASS = "RepublicmagSDK"
