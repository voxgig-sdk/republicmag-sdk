...
module RepublicmagTestRunner
  ...
  def self.env_override(m)
    live = getenv("REPUBLICMAG_TEST_LIVE")
    override = getenv("REPUBLICMAG_TEST_OVERRIDE")
    ...
    explain = getenv("REPUBLICMAG_TEST_EXPLAIN")
    m["REPUBLICMAG_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = RepublicmagTestRunner
Helpers = RepublicmagHelpers
Vs = VoxgigStruct
