...
func registerSDKWords(r *eng.Registry, client *sdk.RepublicmagSDK) {
...
func runOp(client *sdk.RepublicmagSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
