...
The PHP SDK for the Republicmag API — an entity-oriented client using PHP conventions.
...
```
php/
├── republicmag_sdk.php          -- Main SDK class
...
The main class (`republicmag_sdk.php`) exports the SDK class
