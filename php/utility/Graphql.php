...
// Republicmag SDK utility: graphql
//
...
class RepublicmagGraphql
{
    ...
    // equivalent.
    public static function body(RepublicmagContext $ctx): mixed
    {
    ...
    public static function errors(RepublicmagContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
