...
// Republicmag SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class RepublicmagMakeRequest
{
    public static function call(RepublicmagContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new RepublicmagResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new RepublicmagResponse($fetched);
        } else {
