...
// Republicmag SDK timeout feature
...
class RepublicmagTimeoutFeature extends RepublicmagBaseFeature
{
    ...
    private function _with_timeout(RepublicmagContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(RepublicmagContext $_ctx, float $ms): void
    {
        $client = $this->client;
