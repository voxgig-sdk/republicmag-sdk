...
// Republicmag SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class RepublicmagTestFeature extends RepublicmagBaseFeature
{
    ...
    public function init(RepublicmagContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (RepublicmagContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = RepublicmagParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (RepublicmagContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(RepublicmagContext $ctx, $op, $args): array
    {
