...
// Republicmag SDK netsim feature
...
class RepublicmagNetsimFeature extends RepublicmagBaseFeature
{
    ...
    private function _simulate(RepublicmagContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(RepublicmagContext $ctx, array $applied): void
    {
        $client = $this->client;
