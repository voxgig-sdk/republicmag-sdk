...
// Republicmag SDK metrics feature
...
class RepublicmagMetricsFeature extends RepublicmagBaseFeature
{
    ...
    private function _record(RepublicmagContext $ctx, bool $ok): void
    {
