...
class RepublicmagTestRunner
{
    ...
    {
        $live = self::getenv('REPUBLICMAG_TEST_LIVE');
        $override = self::getenv('REPUBLICMAG_TEST_OVERRIDE');
        ...
        $explain = self::getenv('REPUBLICMAG_TEST_EXPLAIN');
...
class_alias('RepublicmagTestRunner', 'Runner');
class_alias('RepublicmagHelpers', 'Helpers');
