...
// Republicmag SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (RepublicmagSDK::test)
...
{
    private const SDK_CLASS = 'RepublicmagSDK';
    ...
    private const SDK_BASE = 'republicmag_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../republicmag_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
